...
class ImageIndexer:
    """
    Indexador de imagens usando FAISS para busca por similaridade.
    """
    ...
    def initialize(self) -> bool:
        """
        Inicializa o indexador: carrega modelo CLIP, processa imagens e cria índice FAISS.
    ...
    def search(self, query_image) -> Tuple[Optional[str], float, int]:
        """
        Busca a imagem mais similar no índice.
        
        Args:
            query_image: Objeto PIL Image da imagem de consulta
            
        Returns:
            Tupla (nome_arquivo, similaridade_0_1, percentagem_0_100)
            Retorna (None, 0.0, 0) se não houver resultados
        """
    ...
    def get_indexed_count(self) -> int:
        """
        Retorna o número de imagens indexadas.
        """
    ...
    def get_all_indexed_files(self) -> List[str]:
        """
        Retorna lista de todos os arquivos indexados.
        """
...
def get_indexer() -> ImageIndexer:
    """
    Retorna instância singleton do ImageIndexer.
    """
